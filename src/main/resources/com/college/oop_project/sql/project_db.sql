...
CREATE
DATABASE IF NOT EXISTS `ors1_opp_2021_2022` ;
USE
`ors1_opp_2021_2022`;
-- --------------------------------------------------------
...
INSERT INTO `izostanci` (`id`, `ucenik_id`, `predmet_u_skoli_id`, `datum`)
VALUES (1, 1, 11, '2021-11-01'),
       (2, 3, 2, '2021-11-01'),
       (3, 4, 2, '2021-11-01'),
       (4, 4, 2, '2021-11-12'),
       (5, 6, 5, '2021-11-04'),
...
INSERT INTO `ocjena` (`id`, `ucenik_id`, `predmet_u_skoli_id`, `ocjena`, `datum`)
VALUES (1, 1, 11, 4, '2021-10-12'),
       (2, 1, 11, 3, '2021-10-21'),
       (3, 1, 12, 2, '2021-10-07'),
       (4, 1, 12, 3, '2021-10-21'),
       (5, 1, 12, 3, '2021-10-30'),
...
INSERT INTO `ocjena_predmeta` (`id`, `predmet_u_skoli_id`, `ucenik_id`, `pitanje_id`, `ocjena`)
VALUES (1, 12, 2, 1, 5),
       (2, 12, 2, 2, 5),
       (3, 12, 2, 3, 5),
       (4, 12, 2, 4, 4),
...
INSERT INTO `pitanje` (`id`, `pitanje`)
VALUES (1, 'Nastava se odrzava redovno'),
...
INSERT INTO `predmet` (`id`, `naziv`, `razred`)
VALUES (1, 'Matematika', 6),
       (2, 'Matematika', 7),
       (3, 'Fizika', 6),
       (4, 'Hemija', 7);
...
INSERT INTO `predmet_u_skoli` (`id`, `predmet_id`, `skola_id`, `profesor_id`)
VALUES (1, 1, 1, 1),
       (2, 1, 2, 2),
       (3, 1, 3, 1),
       (4, 1, 3, 3),
...
INSERT INTO `pristupni_podaci` (`id`, `korisnicko_ime`, `email`, `sifra`)
VALUES (1, 'vukasin.markovic', 'vukasin.markovic@os.sveti.sava.org', '4b1a3595d9b50db479aa8d81a9dd781e'),
...
INSERT INTO `profesor` (`id`, `ime`, `prezime`, `pol`, `pristupni_podaci_id`)
VALUES (1, 'Radomir', 'Jankovic', 1, 9),
...
INSERT INTO `skola` (`id`, `naziv`, `grad`, `mjesto`, `drzava`)
VALUES (1, 'Sveti Sava', 'Gacko', 'Gacko', 'Bosna i Hercegovina'),
...
INSERT INTO `ucenik` (`id`, `ime`, `prezime`, `pol`, `pristupni_podaci_id`)
VALUES (1, 'Vukasin', 'Markovic', 1, 1),
       (2, 'Dusko', 'Tadic', 1, 2),
